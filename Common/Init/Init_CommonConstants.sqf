...
with missionNamespace do {
	...
	if (isNil 'CTI_TOWNS_RESISTANCE_HEAVY') then {CTI_TOWNS_RESISTANCE_HEAVY = 1};//Done
	if (isNil 'CTI_SHOPS_HEAVY') then {CTI_SHOPS_HEAVY = 1};//Done
...
with missionNamespace do {
	...
	if (isNil 'CTI_GRAPHICS_TG_MAX') then {CTI_GRAPHICS_TG_MAX = 25};
