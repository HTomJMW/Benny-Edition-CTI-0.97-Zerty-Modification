...
_v = _v		+ ["Infantry"];
_t = _t		+ ["Infantry"];
_p = _p		+ [[["rhs_msv_emr_rifleman", 5], ["rhs_msv_emr_machinegunner", 2, 80], ["rhs_msv_emr_medic", 1], ["rhs_msv_emr_LAT", 1, 70], ["rhs_msv_emr_grenadier", 2, 90], ["rhs_vdv_marksman_asval", 1, 70], ["rhs_vdv_marksman", 1, 55]]];
_f = _f		+ [CTI_BARRACKS];
_m = _m		+ [500];
_c = _c		+ ["Infantry"];
_s = _s		+ [[]];
...
_v = _v		+ ["InfantryAT"];
_t = _t		+ ["Infantry - AT"];
_p = _p		+ [[["rhs_msv_emr_at", 5, 85], ["rhs_msv_emr_medic", 1], ["rhs_msv_emr_LAT", 3, 75], ["rhs_msv_emr_at", 2, 70]]];
_f = _f		+ [CTI_BARRACKS];
_m = _m		+ [800];
_c = _c		+ ["InfantryAT"];
_s = _s		+ [[]];
...
_p = _p		+ [[["rhs_vdv_marksman_asval", 2], ["rhs_vdv_marksman", 1]]];
_f = _f		+ [CTI_BARRACKS];
_m = _m		+ [900];
...
_p = _p		+ [[["rhs_btr80_msv", 1], ["rhs_btr80a_msv", 1, 50]]];
_f = _f		+ [CTI_HEAVY];
_m = _m		+ [2500];
_c = _c		+ ["Mechanized"];
_s = _s		+ [[]];
...
_v = _v		+ ["Armored"];
_t = _t		+ ["Armored - MBT"];
_p = _p		+ [[["rhs_t72be_tv", 1], ["rhs_t90_tv", 1, 50]]];
_f = _f		+ [CTI_HEAVY];
_m = _m		+ [6500];
_c = _c		+ ["Armored"];
_s = _s		+ [[]];
