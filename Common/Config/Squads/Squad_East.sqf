...
_v = _v		+ ["Infantry"];
_t = _t		+ ["Infantry"];
_p = _p		+ [[["O_T_Soldier_F", 5], ["O_T_soldier_AR_F", 2, 80], ["O_T_medic_F", 1], ["O_T_soldier_LAT_F", 1, 70], ["O_T_Soldier_GL_F", 2, 90], ["O_T_sniper_F", 1, 70], ["O_T_soldier_M_F", 1, 55]]];
_f = _f		+ [CTI_BARRACKS];
_m = _m		+ [500];
_c = _c		+ ["Infantry"];
_s = _s		+ [[]];
...
_v = _v		+ ["InfantryAT"];
_t = _t		+ ["Infantry - AT"];
_p = _p		+ [[["O_T_soldier_AT_F", 5, 85], ["O_T_medic_F", 1], ["O_T_soldier_LAT_F", 3, 75], ["O_T_Soldier_HAT_F", 2, 70]]];
_f = _f		+ [CTI_BARRACKS];
_m = _m		+ [800];
_c = _c		+ ["InfantryAT"];
_s = _s		+ [[]];
...
_v = _v		+ ["InfantryAA"];
_t = _t		+ ["Infantry - AA"];
_p = _p		+ [[["O_T_soldier_AA_F", 5, 85], ["O_T_medic_F", 1], ["O_T_soldier_LAT_F", 2, 60]]];
_f = _f		+ [CTI_BARRACKS];
_m = _m		+ [800];
_c = _c		+ ["InfantryAA"];
_s = _s		+ [[]];
...
_p = _p		+ [[["O_T_sniper_F", 2], ["O_T_soldier_M_F", 1]]];
_f = _f		+ [CTI_BARRACKS];
_m = _m		+ [900];
...
_p = _p		+ [[["O_T_MRAP_02_hmg_ghex_F", 3], ["O_T_MRAP_02_gmg_ghex_F", 2, 75]]];
_f = _f		+ [CTI_LIGHT];
_m = _m		+ [1200];
_c = _c		+ ["Motorized"];
_s = _s		+ [[]];
...
_p = _p		+ [[["O_T_APC_Wheeled_02_rcws_v2_ghex_F", 1], ["O_T_APC_Tracked_02_cannon_ghex_F", 1, 50]]];
_f = _f		+ [CTI_HEAVY];
_m = _m		+ [2500];
_c = _c		+ ["Mechanized"];
_s = _s		+ [[]];
...
_p = _p		+ [[["O_T_APC_Tracked_02_cannon_ghex_F", 1]]];
_f = _f		+ [CTI_HEAVY];
_m = _m		+ [3000];
_c = _c		+ ["Mechanized"];
_s = _s		+ [[]];
...
_v = _v		+ ["Armored"];
_t = _t		+ ["Armored - MBT"];
_p = _p		+ [[["O_T_MBT_02_cannon_ghex_F", 1], ["O_T_MBT_04_cannon_F", 1, 50]]];
_f = _f		+ [CTI_HEAVY];
_m = _m		+ [6500];
_c = _c		+ ["Armored"];
_s = _s		+ [[]];
...
_p = _p		+ [[["O_T_APC_Tracked_02_AA_ghex_F", 1]]];
_f = _f		+ [CTI_HEAVY];
_m = _m		+ [8500];
_c = _c		+ ["AntiAir"];
_s = _s		+ [[]];
